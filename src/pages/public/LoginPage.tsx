...
export default function LoginPage() {
  ...
  return (
    ...
    >
      <ToastContainer />
      <div
        className="d-flex shadow-lg bg-white rounded overflow-hidden"
        ...
        <MDBCard className="p-5 border-0" style={{ width: "50%" }}>
          <MDBCardBody>
            <div className="text-center mb-4">
              <img
                src="https://res.cloudinary.com/dkzn3xjwt/image/upload/v1744118798/c435280f-ab8c-478b-8a38-786fbd5e681a.png"
                alt="Logo"
                height="70"
                width="70"
                className="mb-2"
              />
              <MDBTypography tag="h4" className="fw-bold text-dark">
                Sign In
              </MDBTypography>
            </div>
            <form onSubmit={handleSubmit}>
              ...
              <MDBBtn
                ...
                style={{ backgroundColor: "#E74C3C", borderRadius: "6px" }}
              >
              ...
              <MDBBtn
                ...
                onClick={() =>
                  (window.location.href = `${API.BASE_URL+API.Authentication.GOOGLE}`)
                }
              >
            ...
            <div className="text-center mt-3">
              <p className="mb-0 text-muted">
                ...
                <a
                  onClick={() => navigate(PAGES.REGISTER_PAGE)}
                  className="fw-bold"
